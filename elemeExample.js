...
//const imgTypes = [{src:require('./images/advertisement-image-01.jpg')},{src:require('./images/advertisement-image-02.jpg')},{src:require('./images/advertisement-image-03.jpg')}]
					...
					<View style={styles.lbsWeather}>
						<TouchableWithoutFeedback>
							<View style={styles.lbs}>
								<Image source={require('./images/icon-home.png')} style={{width:px2pd(18),height:px2pd(18)}}></Image>
								<Text style={{fontSize:px2pd(16),fontWeight:'bold',color:'#fff',paddingHorizontal:px2pd(5)}}>{this.state.location}</Text>
								<Image source={require('./images/icon-home.png')} style={{width:px2pd(16),height:px2pd(16)}}></Image>
							</View>
						</TouchableWithoutFeedback>
						<View style={styles.weather}>
							...
							<Image source={require('./images/icon-home.png')} style={{width:px2pd(20),height:px2pd(20)}}></Image>
						</View>
					</View>
					{/*搜索框*/}
							...
							types.map((item, i) => {
								let render = (
									<View style={[{width: w, height: h}, styles.typesItem]}>
										<Image source={require('./images/advertisement-image-01.jpg')} style={{width: w*.5, height: w*.5}}/>
